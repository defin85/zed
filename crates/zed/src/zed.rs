...
use symbol_browser::SymbolBrowserPanel;
use paths::{
...
fn initialize_panels(window: &mut Window, cx: &mut Context<Workspace>) -> Task<anyhow::Result<()>> {
    cx.spawn_in(window, async move |workspace_handle, cx| {
        ...
        let symbol_browser_panel = SymbolBrowserPanel::load(workspace_handle.clone(), cx.clone());
        ...
        futures::join!(
            ...
            add_panel_when_ready(symbol_browser_panel, workspace_handle.clone(), cx.clone()),
